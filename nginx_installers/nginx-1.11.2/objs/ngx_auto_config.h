#define NGX_CONFIGURE " --prefix=/percoo_home/Library/nginx --add-module=/percoo_home/Library/rvm/gems/ruby-2.3.0/gems/passenger-5.0.29/src/nginx_module --add-module=/percoo_home/Library/nginx/nginx_installers/nginx-rtmp-module/"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 5.3.0 (Homebrew gcc 5.3.0) "
#endif
...
#define PASSENGER_NGINX_MINOR_VERSION  11
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/percoo_home/Library/nginx/"
#endif
